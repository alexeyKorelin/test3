...
export default class ScrollArea extends React.Component {
    ...
    render() {
        ...
        let scrollbarY = this.canScrollY() ? (
            <ScrollBar
                ...
                containerClassName={this.props.scrollBarContainerClassName}
                scrollBarClassName={this.props.scrollBarClassName}
    ...
    computeLeftPosition(deltaX, sizes) {
        let newLeftPosition = this.state.leftPosition - (this.props.scrollBarSize ? this.state.containerWidth / this.props.scrollBarSize * deltaX : deltaX);
...
ScrollArea.propTypes = {
    ...
    scrollBarContainerClassName: PropTypes.string,
